    ...
    <div className="w-full bg-[#f8f9fa] min-h-full">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-lg font-bold text-gray-700 flex items-center gap-2">
          Berita <span className="text-gray-400 font-normal">&gt;</span> <span className="text-[#107058]">Edit Berita</span>
        </h1>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 space-y-6">
          <div>
            ...
            <input type="text" defaultValue="Musrenbang Kecamatan Banyuwangi Tahun 2026" className="w-full border border-gray-200 rounded-lg p-3 bg-white focus:outline-none focus:border-[#107058] shadow-sm" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-[#107058] mb-2">Kategori</label>
              <select defaultValue="Kegiatan" className="w-full border border-gray-200 rounded-lg p-3 bg-white focus:outline-none focus:border-[#107058] shadow-sm">
          ...
          <div>
            ...
            <div className="border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm">
              <div className="flex items-center gap-4 bg-gray-50 border-b border-gray-200 p-3 text-gray-600">
                <button><FaBold /></button><button><FaItalic /></button><button><FaUnderline /></button>
              </div>
        ...
        <div className="w-full lg:w-72 space-y-8">
          <div>
            ...
            <button className="w-full border border-gray-300 bg-white text-gray-700 py-2 rounded-lg text-sm font-bold hover:bg-gray-50 shadow-sm">Ganti Foto Baru</button>
          </div>
          <div className="flex justify-end gap-3 pt-6">
            ...
            <button className="px-6 py-2.5 rounded-lg text-sm font-bold text-white bg-[#01352c] hover:bg-[#0a5240] shadow-md">Simpan Perubahan</button>
          </div>
        </div>
      </div>
    </div>
